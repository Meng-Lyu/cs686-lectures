...
## Scoring (new rules for projects)
 ...
 - The starter code (as-is) would give you 46 points (out of 10,000) with 2/15, 6/16, and 0/8 being the number of tests it passes. (This statement is now outdated, but it shouldn't really affect you anymore.)
